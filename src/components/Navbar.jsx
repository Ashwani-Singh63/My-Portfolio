const Navbar = () => {
  return (
    <div className="w-full sm:px-40 px-10 py-8  text-white mb-10"> 
      <div className="flex items-center justify-between h-full  "> 
        ...
        <div>
          <button className="px-6 py-2 rounded-xl text-xl border-2 font-semibold border-white hover:bg-gray-600 bg-gray-700 transition cursor-pointer">
            Let&apos;s Talk
          </button>
        </div>
      </div>
